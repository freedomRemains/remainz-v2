 ...
 *
 * <p>
 * 対象は{@code com.freedom.remainz_v2.web.controller}配下のコントローラが持つ全ての公開メソッド
 * (URIパターンに対応する{@code @GetMapping}/{@code @PostMapping}メソッド)です。開始時のログは
 * {@code RemainzV2Controller#logRequestInfo}で既に出力しているため、本Aspectでは処理終了時に
...
public class ControllerLoggingAspect {
    ...
    @Around("execution(public * com.freedom.remainz_v2.web.controller..*(..))")
