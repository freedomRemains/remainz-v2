package com.freedom.remainz_v2.common.db.aspect;
 ...
 *
 * <p>
 * {@code RecordQueryService}(SELECT専用)、及び{@code CreateRecordService}等の各Write系サービスは
 * いずれも{@link org.springframework.jdbc.core.JdbcTemplate}を直接注入して利用しているため、
