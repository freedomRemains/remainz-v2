...
class RemainzV2ControllerTest {
    ...
    void setUp() {
        ...
        listAppender.start();
        ((Logger) org.slf4j.LoggerFactory.getLogger(RemainzV2Controller.class)).addAppender(listAppender);
    }

    @AfterEach
    void tearDown() {
        ((Logger) org.slf4j.LoggerFactory.getLogger(RemainzV2Controller.class)).detachAppender(listAppender);
    }
